    ...
    def __init__(self, border, width, box_size):
        ...
        if not self._all_cached_images:
            self._all_cached_images = [
                Image.open("a.png").resize((self.box_size, self.box_size),
                                           Image.ANTIALIAS),
                Image.open("b.png").resize((self.box_size, self.box_size),
                                           Image.ANTIALIAS),
                Image.open("c.png").resize((self.box_size, self.box_size),
                                           Image.ANTIALIAS),
                Image.open("d.png").resize((self.box_size, self.box_size),
                                           Image.ANTIALIAS),
                Image.open("e.png").resize((self.box_size, self.box_size),
                                           Image.ANTIALIAS),
                Image.open("f.png").resize((self.box_size, self.box_size),
                                           Image.ANTIALIAS),
            ]
