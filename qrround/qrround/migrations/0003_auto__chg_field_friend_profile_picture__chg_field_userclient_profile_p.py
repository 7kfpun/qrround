...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Friend.profile_picture'
        db.alter_column(u'qrround_friend', 'profile_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'UserClient.profile_picture'
        db.alter_column(u'qrround_userclient', 'profile_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'CachedImage.photo'
        db.alter_column(u'qrround_cachedimage', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

        # Changing field 'QRCode.photo'
        db.alter_column(u'qrround_qrcode', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Friend.profile_picture'
        db.alter_column(u'qrround_friend', 'profile_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'UserClient.profile_picture'
        db.alter_column(u'qrround_userclient', 'profile_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'CachedImage.photo'
        db.alter_column(u'qrround_cachedimage', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'QRCode.photo'
        db.alter_column(u'qrround_qrcode', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
