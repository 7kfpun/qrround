...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Friend', fields ['client']
        db.create_unique(u'qrround_friend', ['client'])


    def backwards(self, orm):
        # Removing unique constraint on 'Friend', fields ['client']
        db.delete_unique(u'qrround_friend', ['client'])
