...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CachedImage', fields ['url']
        db.create_unique(u'qrround_cachedimage', ['url'])


    def backwards(self, orm):
        # Removing unique constraint on 'CachedImage', fields ['url']
        db.delete_unique(u'qrround_cachedimage', ['url'])
