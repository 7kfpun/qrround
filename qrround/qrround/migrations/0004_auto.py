...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CachedImage', fields ['url']
        db.create_index(u'qrround_cachedimage', ['url'])


    def backwards(self, orm):
        # Removing index on 'CachedImage', fields ['url']
        db.delete_index(u'qrround_cachedimage', ['url'])
