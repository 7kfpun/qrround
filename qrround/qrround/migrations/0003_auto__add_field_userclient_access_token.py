...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserClient.access_token'
        db.add_column(u'qrround_userclient', 'access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserClient.access_token'
        db.delete_column(u'qrround_userclient', 'access_token')
