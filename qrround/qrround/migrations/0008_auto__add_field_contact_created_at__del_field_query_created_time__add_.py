...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'qrround_contact', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 2, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Query.created_time'
        db.delete_column(u'qrround_query', 'created_time')

        # Adding field 'Query.created_at'
        db.add_column(u'qrround_query', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 2, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'qrround_contact', 'created_at')

        # Adding field 'Query.created_time'
        db.add_column(u'qrround_query', 'created_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 2, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Query.created_at'
        db.delete_column(u'qrround_query', 'created_at')
    ...
    models = {
        ...
        u'qrround.qrcode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '255'}),
