...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserClient.is_superuser'
        db.add_column(u'qrround_userclient', 'is_superuser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserClient.is_superuser'
        db.delete_column(u'qrround_userclient', 'is_superuser')
