...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.year_in_school'
        db.add_column(u'qrround_query', 'year_in_school',
                      self.gf('django.db.models.fields.CharField')(default='FR', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.year_in_school'
        db.delete_column(u'qrround_query', 'year_in_school')
